...
// angular:jit:template:src\app\pacientes\pacientes.html
var pacientes_default;
var init_pacientes = __esm({
  "angular:jit:template:src\\app\\pacientes\\pacientes.html"() {
    pacientes_default = `<!-- MODAL -->\r
<div class="modal-overlay" *ngIf="mostrarFormulario" (click)="ocultarFormulario()">\r
  <div class="modal-content" (click)="$event.stopPropagation()">\r
    <div class="form-container">\r
      <h2>{{ editando ? 'Modificar Paciente' : 'Registrar Paciente' }}</h2>\r
      <form [formGroup]="pacienteForm" (ngSubmit)="registrarPaciente()">\r
        <div class="form-row">\r
          <div class="form-group">\r
            <label for="dni">Documento de Identidad</label>\r
            <input type="text" id="dni" formControlName="dni" placeholder="Ingrese DNI" [readonly]="editando">\r
          </div>\r
          <div class="form-group">\r
            <label for="nombres">Nombres</label>\r
            <input type="text" id="nombres" formControlName="nombres" placeholder="Ingrese nombres">\r
          </div>\r
          <div class="form-group">\r
            <label for="apellidos">Apellidos</label>\r
            <input type="text" id="apellidos" formControlName="apellidos" placeholder="Ingrese apellidos">\r
          </div>\r
        </div>\r
\r
        <div class="form-row">\r
          <div class="form-group gender-group">\r
            <label>Sexo</label>\r
            <div class="radio-group">\r
              <label class="radio-label">\r
                <input type="radio" formControlName="sexo" value="M">\r
                <span class="radio-custom"></span>\r
                Masculino\r
              </label>\r
              <label class="radio-label">\r
                <input type="radio" formControlName="sexo" value="F">\r
                <span class="radio-custom"></span>\r
                Femenino\r
              </label>\r
            </div>\r
          ...
          <div class="form-group">\r
            <label for="fechaNacimiento">Fecha de Nacimiento</label>\r
            <input type="date" id="fechaNacimiento" formControlName="fechaNacimiento">\r
          </div>\r
          <div class="form-group">\r
            <label for="telefono">Tel\xE9fono</label>\r
            <input type="tel" id="telefono" formControlName="telefono" placeholder="Ingrese tel\xE9fono">\r
          </div>\r
        </div>\r
\r
        <div class="form-row">\r
          <div class="form-group full-width">\r
            ...
            <input type="email" id="correo" formControlName="correo" placeholder="Ingrese correo electr\xF3nico">\r
          </div>\r
        </div>\r
\r
        <div class="form-row">\r
          <div class="form-group allergies-group">\r
            <label>Alergias</label>\r
            <div class="radio-group">\r
              <label class="radio-label">\r
                <input type="radio" formControlName="alergias" value="SI">\r
                <span class="radio-custom"></span>\r
                S\xED\r
              </label>\r
              <label class="radio-label">\r
                <input type="radio" formControlName="alergias" value="NO">\r
                <span class="radio-custom"></span>\r
                No\r
              </label>\r
            </div>\r
...
\r
        <div class="form-actions">\r
          <button type="submit" class="btn btn-primary" [disabled]="!pacienteForm.valid">\r
            {{ editando ? 'Guardar Cambios' : 'Registrar' }}\r
          </button>\r
          <button type="button" class="btn btn-secondary" (click)="ocultarFormulario()">\r
            Cancelar\r
          </button>\r
        </div>\r
      </form>\r
...
\r
<!-- LISTA PACIENTES -->\r
<div class="pacientes-container">\r
  <div class="header-section">\r
    <div class="actions-bar">\r
      <button class="btn btn-primary" (click)="mostrarFormularioRegistro()">\r
       <i class="ri-file-edit-fill"></i> Registrar Paciente\r
      </button>\r
      <button class="btn btn-secondary" (click)="alternarVistaPacientes()">\r
        {{ mostrarInactivos ? 'Lista de pacientes activos' : 'Lista de pacientes inactivos' }}\r
      </button>\r
      <div class="search-container">\r
        <input type="text" placeholder="Buscar..." [(ngModel)]="busqueda" (input)="buscarPacientes()" class="search-input">\r
        <button class="search-btn"><i class="ri-search-eye-fill"></i></button>\r
      </div>\r
    </div>\r
  </div>\r
\r
  <div class="table-container">\r
    <table class="pacientes-table">\r
      <thead>\r
        <tr>\r
          <th>DNI</th>\r
          <th>NOMBRES</th>\r
      ...
      <tbody>\r
        <tr *ngFor="let paciente of pacientesFiltrados">\r
          <td>{{ paciente.dni }}</td>\r
          <td>{{ paciente.nombres }}</td>\r
          <td>{{ paciente.apellidos }}</td>\r
          <td>{{ paciente.sexo }}</td>\r
          <td>{{ paciente.fechaNacimiento }}</td>\r
          <td>{{ paciente.telefono }}</td>\r
          <td>{{ paciente.correo }}</td>\r
          <td>{{ paciente.alergias }}</td>\r
          <td class="actions-cell">\r
            <button class="btn-action btn-modify" (click)="modificarPaciente(paciente.dni)">\r
             <i class="ri-ball-pen-fill"></i> Modificar\r
            </button>\r
            <button *ngIf="paciente.estado" class="btn-action btn-inactive" (click)="inactivarPaciente(paciente.dni)">\r
              <i class="ri-user-unfollow-fill"></i> Inactivar\r
            </button>\r
            <button *ngIf="!paciente.estado" class="btn-action btn-active" (click)="activarPaciente(paciente.dni)">\r
              <i class="ri-user-follow-fill"></i> Activar\r
            </button>\r
          </td>\r
        </tr>\r
      </tbody>\r
...
var require_sweetalert2_all = __commonJS({
  "node_modules/sweetalert2/dist/sweetalert2.all.js"(exports, module) {
    ...
    (function(global, factory) {
      ...
      const warnAboutDeprecation = /* @__PURE__ */ __name((deprecatedParam, useInstead = null) => {
      ...
      const getContainer = /* @__PURE__ */ __name(() => document.body.querySelector(`.${swalClasses.container}`), "getContainer");
      ...
      const getIconContent = /* @__PURE__ */ __name(() => elementByClass(swalClasses["icon-content"]), "getIconContent");
      ...
      const getLoader = /* @__PURE__ */ __name(() => elementBySelector(`.${swalClasses.loader}`), "getLoader");
...
`;
      ...
      const getInput$1 = /* @__PURE__ */ __name((popup, inputClass) => {
        if (!inputClass) {
          return null;
        }
        switch (inputClass) {
      ...
      const getDirectChildByClass = /* @__PURE__ */ __name((elem, className) => {
      ...
      const show = /* @__PURE__ */ __name((elem, display = "flex") => {
        if (!elem) {
          return;
        }
      ...
      const showWhenInnerHtmlPresent = /* @__PURE__ */ __name((elem, display = "block") => {
        if (!elem) {
          return;
        }
      ...
      const toggle = /* @__PURE__ */ __name((elem, condition, display = "flex") => {
        if (condition) {
          show(elem, display);
        } else {
          hide(elem);
      ...
      const isVisible$1 = /* @__PURE__ */ __name((elem) => !!(elem && (elem.offsetWidth || elem.offsetHeight || elem.getClientRects().length)), "isVisible$1");
      const allButtonsAreHidden = /* @__PURE__ */ __name(() => !isVisible$1(getConfirmButton()) && !isVisible$1(getDenyButton()) && !isVisible$1(getCancelButton()), "allButtonsAreHidden");
      const isScrollable = /* @__PURE__ */ __name((elem) => !!(elem.scrollHeight > elem.clientHeight), "isScrollable");
      const selfOrParentIsScrollable = /* @__PURE__ */ __name((element, stopElement) => {
        let parent = element;
      ...
      const animateTimerProgressBar = /* @__PURE__ */ __name((timer, reset = false) => {
...
`.replace(/(^|\n)\s*/g, "");
      ...
      const resetValidationMessage$1 = /* @__PURE__ */ __name(() => {
      ...
      const setAttributes = /* @__PURE__ */ __name((inputClass, inputAttributes) => {
        const popup = getPopup();
        if (!popup) {
          return;
        }
      ...
      const checkAndSetInputValue = /* @__PURE__ */ __name((input, inputValue) => {
      ...
      const adjustSuccessIconBackgroundColor = /* @__PURE__ */ __name(() => {
        const popup = getPopup();
        if (!popup) {
          return;
        }
      ...
      const successIconHtml = /* @__PURE__ */ __name((params) => `
...
`;
      ...
      const iconContent = /* @__PURE__ */ __name((content) => `<div class="${swalClasses["icon-content"]}">${content}</div>`, "iconContent");
      ...
      let initialX = 0;
      let initialY = 0;
      const addDraggableListeners = /* @__PURE__ */ __name((popup) => {
      ...
      const removeDraggableListeners = /* @__PURE__ */ __name((popup) => {
      ...
      const down = /* @__PURE__ */ __name((event) => {
        const popup = getPopup();
      ...
      const move = /* @__PURE__ */ __name((event) => {
        const popup = getPopup();
        if (dragging) {
          let {
            clientX,
      ...
      const getClientXY = /* @__PURE__ */ __name((event) => {
      ...
      const addClasses$1 = /* @__PURE__ */ __name((popup, params) => {
      ...
      const isVisible = /* @__PURE__ */ __name(() => {
        return isVisible$1(getPopup());
      }, "isVisible");
      const clickConfirm = /* @__PURE__ */ __name(() => {
        var _dom$getConfirmButton;
        return (_dom$getConfirmButton = getConfirmButton()) === null || _dom$getConfirmButton === void 0 ? void 0 : _dom$getConfirmButton.click();
      }, "clickConfirm");
      const clickDeny = /* @__PURE__ */ __name(() => {
        var _dom$getDenyButton;
        return (_dom$getDenyButton = getDenyButton()) === null || _dom$getDenyButton === void 0 ? void 0 : _dom$getDenyButton.click();
      }, "clickDeny");
      const clickCancel = /* @__PURE__ */ __name(() => {
      ...
      const removeKeydownHandler = /* @__PURE__ */ __name((globalState2) => {
      ...
      const addKeydownHandler = /* @__PURE__ */ __name((globalState2, innerParams, dismissWith) => {
      ...
      const setFocus = /* @__PURE__ */ __name((index, increment) => {
        var _dom$getPopup;
      ...
      const keydownHandler = /* @__PURE__ */ __name((innerParams, event, dismissWith) => {
        if (!innerParams) {
          return;
        }
      ...
      const handleEnter = /* @__PURE__ */ __name((event, innerParams) => {
      ...
      const handleTab = /* @__PURE__ */ __name((event) => {
      ...
      const handleEsc = /* @__PURE__ */ __name((event, innerParams, dismissWith) => {
        event.preventDefault();
      ...
      const isStylus = /* @__PURE__ */ __name((event) => {
      ...
      const replaceScrollbarWithPadding = /* @__PURE__ */ __name((initialBodyOverflow) => {
      ...
      const undoReplaceScrollbarWithPadding = /* @__PURE__ */ __name(() => {
        if (previousBodyPadding !== null) {
      ...
      const getFileValue = /* @__PURE__ */ __name((input) => input.files && input.files.length ? input.getAttribute("multiple") !== null ? input.files : input.files[0] : null, "getFileValue");
      ...
      const rejectWith = /* @__PURE__ */ __name((instance, error2) => {
      ...
      const filterValidParams = /* @__PURE__ */ __name((params) => {
      ...
      const handlePopupClick = /* @__PURE__ */ __name((innerParams, domCache, dismissWith) => {
        if (innerParams.toast) {
      ...
      const handleToastClick = /* @__PURE__ */ __name((innerParams, domCache, dismissWith) => {
      ...
      const isAnyButtonShown = /* @__PURE__ */ __name((innerParams) => {
      ...
      const handleModalClick = /* @__PURE__ */ __name((innerParams, domCache, dismissWith) => {
      ...
      const increaseTimer = /* @__PURE__ */ __name((ms) => {
        if (globalState.timeout) {
      ...
      const on = /* @__PURE__ */ __name((eventName, eventHandler) => {
        globalState.eventEmitter.on(eventName, eventHandler);
      }, "on");
      const once = /* @__PURE__ */ __name((eventName, eventHandler) => {
        globalState.eventEmitter.once(eventName, eventHandler);
      }, "once");
      const off = /* @__PURE__ */ __name((eventName, eventHandler) => {
        if (!eventName) {
      ...
      const getSwalFunctionParams = /* @__PURE__ */ __name((templateContent) => {
        const result = {};
      ...
      const showWarningsForElements = /* @__PURE__ */ __name((templateContent) => {
      ...
      const addClasses = /* @__PURE__ */ __name((container, popup, params) => {
      ...
      const _SweetAlert = class _SweetAlert {
        /**
         * @param {...any} args
         * @this {SweetAlert}
         */
      ...
      const setupTimer = /* @__PURE__ */ __name((globalState2, innerParams, dismissWith) => {
        const timerProgressBar = getTimerProgressBar();
      ...
      const focusAutofocus = /* @__PURE__ */ __name((domCache) => {
...
var import_sweetalert2, _a, Pacientes;
var init_pacientes3 = __esm({
  "src/app/pacientes/pacientes.ts"() {
    "use strict";
    init_tslib_es6();
    init_pacientes();
    ...
    Pacientes = (_a = class {
      ...
      registrarPaciente() {
        if (this.pacienteForm.valid) {
          ...
          if (this.editando && this.dniEditando) {
            const index = this.pacientes.findIndex((p) => p.dni === this.dniEditando);
            if (index !== -1) {
              this.pacientes[index] = __spreadValues(__spreadValues({}, this.pacientes[index]), datosPaciente);
            }
            this.editando = false;
            this.dniEditando = null;
            import_sweetalert2.default.fire({
              title: "\xA1Paciente Modificado!",
              text: "Los datos se actualizaron correctamente.",
              icon: "success"
            });
          } else {
            const nuevoPacienteConEstado = __spreadProps(__spreadValues({}, datosPaciente), { estado: true });
            this.pacientes.push(nuevoPacienteConEstado);
            import_sweetalert2.default.fire({
              title: "\xA1Registro Exitoso!",
              text: "\xA1El paciente ha sido registrado con \xE9xito!",
              icon: "success"
            });
          }
          this.filtrarLista();
      ...
      inactivarPaciente(dni) {
        import_sweetalert2.default.fire({
          title: "\xBFEst\xE1s seguro?",
          text: "\xA1El paciente ser\xE1 marcado como inactivo!",
          icon: "warning",
          showCancelButton: true,
          confirmButtonText: "S\xED, inactivar",
          ...
          if (result.isConfirmed) {
            ...
            if (paciente) {
              ...
              this.filtrarLista();
              import_sweetalert2.default.fire("\xA1Inactivado!", "El paciente ha sido marcado como inactivo.", "success");
            }
          }
        });
      }
      activarPaciente(dni) {
        import_sweetalert2.default.fire({
          title: "\xBFDeseas activar este paciente?",
          text: "\xA1El paciente volver\xE1 a la lista de activos!",
          icon: "info",
          showCancelButton: true,
          confirmButtonText: "S\xED, activar",
          cancelButtonText: "Cancelar"
        }).then((result) => {
          if (result.isConfirmed) {
            const paciente = this.pacientes.find((p) => p.dni === dni);
            if (paciente) {
              ...
              this.filtrarLista();
              import_sweetalert2.default.fire("\xA1Activado!", "El paciente ha sido marcado como activo.", "success");
            }
          }
        });
      }
      filtrarLista() {
        if (this.busqueda.trim() === "") {
          this.pacientesFiltrados = this.pacientes.filter((p) => p.estado === !this.mostrarInactivos);
        } else {
          this.pacientesFiltrados = this.pacientes.filter((p) => p.estado === !this.mostrarInactivos && (p.nombres.toLowerCase().includes(this.busqueda.toLowerCase()) || p.apellidos.toLowerCase().includes(this.busqueda.toLowerCase()) || p.dni.includes(this.busqueda)));
        }
      }
      alternarVistaPacientes() {
        this.mostrarInactivos = !this.mostrarInactivos;
        this.filtrarLista();
      }
    }, __name(_a, "Pacientes"), __publicField(_a, "ctorParameters", /* @__PURE__ */ __name(() => [
      { type: FormBuilder }
    ], "ctorParameters")), _a);
    Pacientes = __decorate([
      Component({
        ...
        template: pacientes_default,
        styles: [pacientes_default2]
      })
    ], Pacientes);
  }
});

// src/app/pacientes/pacientes.spec.ts
var require_pacientes_spec = __commonJS({
  "src/app/pacientes/pacientes.spec.ts"(exports) {
    init_testing();
    init_pacientes3();
    describe("Pacientes", () => {
      let component;
...
export default require_pacientes_spec();
...
sweetalert2/dist/sweetalert2.all.js:
  ...
  *)
*/
//# sourceMappingURL=spec-pacientes.spec.js.map
